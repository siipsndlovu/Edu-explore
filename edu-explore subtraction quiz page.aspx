...
<script runat="server">
    void Page_Load()
    {
        if (!Page.IsPostBack)
        {
            bool subquizCheck = System.Convert.ToBoolean(Session["SubQuizreq"]);
            if (subquizCheck == !true)
            {
    ...
    public void ScoreCalculation() {
        ...
        r = cmd.ExecuteReader();
        if (r.Read()){
            hs = System.Convert.ToInt32(r["SubQuizScore"]);
            Session["highscore2"] = hs;
        }
        cn.Close();
        int hsc = System.Convert.ToInt32(Session["highscore2"]);
        if (score > hsc)
        {
            ...
            OleDbDataReader r2;
            cn2.Open();
            string sql2 = "UPDATE Accounts SET [SubQuizScore] = '" + score + "' WHERE [Username] = '" + un + "' AND [Password] = '" + pw + "';";
            ...
            if (score >= 3 && score < 6)
            {
                ...
                OleDbDataReader r3;
                cn3.Open();
                string sql3 = "UPDATE Accounts SET [SubMedals] = '" + bronze + "' WHERE [Username] = '" + un + "' AND [Password] = '" + pw + "';";
            ...
            if (score >= 6 && score < 8)
            {
                ...
                OleDbDataReader r4;
                cn4.Open();
                string sql4 = "UPDATE Accounts SET [SubMedals] = '" + silver + "' WHERE [Username] = '" + un + "' AND [Password] = '" + pw + "';";
                ...
                OleDbDataReader r6;
                cn6.Open();
                string sql6 = "UPDATE Accounts SET [Unicorn] = '" + one + "' WHERE [Username] = '" + un + "' AND [Password] = '" + pw + "';";
                cmd6 = new OleDbCommand(sql6, cn6);
                r6 = cmd6.ExecuteReader();
                cn6.Close();
                MessageBox.Show("Well done you have UNLOCKED the following PROFILE PICTURE [UNICORN].");
            }
            if (score >= 8)
            {
                int one = 1;
                ...
                OleDbDataReader r5;
                cn5.Open();
                string sql5 = "UPDATE Accounts SET [SubMedals] = '" + gold + "' WHERE [Username] = '" + un + "' AND [Password] = '" + pw + "';";
                ...
                OleDbDataReader r7;
                cn7.Open();
                string sql7 = "UPDATE Accounts SET [Dino] = '" + one + "' WHERE [Username] = '" + un + "' AND [Password] = '" + pw + "';";
                cmd7 = new OleDbCommand(sql7, cn7);
                r7 = cmd7.ExecuteReader();
                cn7.Close();
                MessageBox.Show("Well done you have UNLOCKED the following PROFILE PICTURE [DINO].");
            }
...
<body>
    <form runat="server">
        ...
        <div class="parQ1">
            ...
            <img id="imgQ1minus" src="minus.png" />
        ...
        <div class="parQ2">
            ...
            <img id="imgQ2minus" src="minus.png" />
        ...
        <div class="parQ3">
            ...
            <img id="imgQ3minus" src="minus.png" />
        ...
        <div class="parQ4">
            ...
            <img id="imgQ4minus" src="minus.png" />
        ...
        <div class="parQ5">
            ...
            <img id="imgQ5minus" src="minus.png" />
        ...
        <div class="parQ6">
            ...
            <img id="imgQ6minus" src="minus.png" />
        ...
        <div class="parQ7">
            ...
            <img id="imgQ7minus" src="minus.png" />
        ...
        <div class="parQ8">
            ...
            <img id="imgQ8minus" src="minus.png" />
        ...
        <div class="parQ9">
            ...
            <img id="imgQ9minus" src="minus.png" />
        ...
        <div class="parQ10">
            ...
            <img id="imgQ10minus" src="minus.png" />
